...
int main ()
{
  ...
  if ( pcl::io::loadPCDFile <pcl::PointXYZ> ("/Users/nadamourad/Desktop/GraphCut-PCD-Segmentation/Dataset/06_02_2024_08_18/med_scaled.pcd", *cloud) == -1 )
  {
...
//0.027040696692439622 -0.007762121469941318 0.46109863608452334
  //point2
  point.x = 0.027040696692439622 ;
  point.y = -0.007762121469941318;
  point.z =0.46109863608452334;
